...
@ApiModel( value = "AVLName", description = "" )
public class AVLName  implements Serializable  {
	...
	public void setAvlname(String Avlname) {
		this.Avlname = Avlname;
	}


	public String getAvlname() {
		return Avlname;
	}

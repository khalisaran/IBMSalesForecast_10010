...
public class IBUser implements UserDetails {
	...
	*/
	...
	public IBUser(String firstName, String lastName) {
		super();
    ...
    private Set<IBAuthority>  roles = new HashSet<IBAuthority>();;
    @Column
	...
	public Set<IBAuthority> getRoles() {
		return roles;
	}

	public void setRoles(Set<IBAuthority> roles) {
		this.roles = roles;
	}
